...
def prepare_undub(source_filename: str, target_filename: str):
    ...
    copyfile(source_filename, new_target_filename)
...
def undub(source_filename: str, target_filename: str):
    target_filename = prepare_undub(source_filename, target_filename)
